...
namespace CompHomp.Migrations
{
    ...
    [Migration("20250312135441_dajsdjasd")]
    partial class dajsdjasd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CompHomp.Models.Build", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CaseId = 1,
                            CpuId = 1,
                            CreatedDate = new DateTime(2025, 3, 12, 17, 54, 40, 875, DateTimeKind.Local).AddTicks(2976),
                        ...
                        new
                        {
                            ...
                            CaseId = 2,
                            CpuId = 2,
                            CreatedDate = new DateTime(2025, 3, 12, 17, 54, 40, 875, DateTimeKind.Local).AddTicks(2983),
            ...
            modelBuilder.Entity("CompHomp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "admin",
                            LoginAttempts = 0,
                            Password = "$2a$11$4ao92cFbfGEBFSVwDUMUxOJ39Tumj0e7R78pcI8jLVSRcBpTw6ZmG",
                            RegistrationDate = new DateTime(2025, 3, 12, 17, 54, 40, 736, DateTimeKind.Local).AddTicks(2161),
                            Role = 1
                        },
                        new
                        {
                            ...
                            Login = "user1",
                            LoginAttempts = 0,
                            Password = "$2a$11$3dkxz0HFIee36VidFcORk.GIKgWbkOYyS0q3lFRWHdJS8FqmWm1G.",
                            RegistrationDate = new DateTime(2025, 3, 12, 17, 54, 40, 875, DateTimeKind.Local).AddTicks(1436),
                            Role = 0
                        });
                });
            ...
            modelBuilder.Entity("CompHomp.Models.Build", b =>
                {
                    ...
                    b.HasOne("CompHomp.Models.Cpu", "Processor")
                        .WithMany()
                        .HasForeignKey("CpuId");

                    b.HasOne("CompHomp.Models.Gpu", "VideoCard")
                        .WithMany()
                        .HasForeignKey("GpuId");
                    ...
                    b.HasOne("CompHomp.Models.Psu", "PowerSupply")
                        .WithMany()
                        .HasForeignKey("PsuId");

                    b.HasOne("CompHomp.Models.Ram", "Memory")
                        .WithMany()
                        .HasForeignKey("RamId");
